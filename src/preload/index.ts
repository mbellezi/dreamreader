...
const api = {
  ...
  voices: {
    ...
    generateDesignPreview: (input: Record<string, unknown>) => invoke("voices.generateDesignPreview", input),
    commitDesignPreview: (input: Record<string, unknown>) => invoke("voices.commitDesignPreview", input),
    discardDesignPreview: (input: Record<string, unknown>) => invoke("voices.discardDesignPreview", input),
