...
export function registerIpc(services: Services): void {
  ...
  handle("tts.segmentChapters", contract["tts.segmentChapters"].request, (input) => services.tts.segmentChapters(input))
  ...
  handle("tts.searchSegments", contract["tts.searchSegments"].request, (input) => services.tts.searchSegments(input))
  handle("tts.regenerateSegment", contract["tts.regenerateSegment"].request, (input) => services.tts.regenerateSegment(input))
