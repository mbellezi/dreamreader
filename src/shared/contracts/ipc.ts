...
import {
  ...
  RegenerateTtsSegmentRequestSchema,
  SearchTtsSegmentsRequestSchema,
  SegmentChaptersTtsRequestSchema,
...
export type {
  ...
  RuntimeOperationJob,
  RuntimeSidecar,
  RegenerateTtsSegmentRequest,
  SearchTtsSegmentsRequest,
  SegmentChaptersTtsRequest,
...
export const IpcContractSchemas = {
  ...
  "tts.segmentChapters": {
    request: SegmentChaptersTtsRequestSchema,
    response: createIpcResponseSchema(z.array(TtsJobSchema)),
  },
  "tts.cancelJob": {
  ...
  "tts.searchSegments": {
    request: SearchTtsSegmentsRequestSchema,
    response: createIpcResponseSchema(z.array(TtsSegmentSummarySchema)),
  },
  "tts.regenerateSegment": {
    request: RegenerateTtsSegmentRequestSchema,
    response: createIpcResponseSchema(TtsSegmentSummarySchema),
  },
  "tts.clearChapterAudio": {
